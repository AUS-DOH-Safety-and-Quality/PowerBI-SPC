...
function extractConditionalFormatting<SettingsT extends defaultSettingsType[defaultSettingsKey]>(inputView: DataViewCategorical, name: string, inputSettings: settingsClass): SettingsT[] {
